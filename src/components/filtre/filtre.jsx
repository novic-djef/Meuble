          ...
          <Disclosure.Panel className="border-t border-gray-200 py-10">
            <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-4 px-4 text-sm sm:px-6 md:gap-x-6 lg:px-8">
              <div className="grid auto-rows-min grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-x-6">
                <fieldset>
                  <legend className="block font-medium">votre interval de Prix</legend>
                ...
                <fieldset>
                  <legend className="block font-medium">Votre ville souhaité</legend>
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
              ...
              <div className="grid auto-rows-min grid-cols-1 gap-y-10 md:grid-cols-2 md:gap-x-6">
                <fieldset>
                  <legend className="block font-medium">Nombre de chambres</legend>
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
                ...
                <fieldset>
                  <legend className="block font-medium">Lieu souhaité</legend>
                  <div className="space-y-6 pt-6 sm:space-y-4 sm:pt-4">
